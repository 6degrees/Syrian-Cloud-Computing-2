...
export const s = {
  ...
  introVisualTitle: { fontFamily: SF, fontSize: 26, lineHeight: 1.15, color: C.text, letterSpacing: '-0.01em', maxWidth: 720 },
  introVisualMeta: { fontSize: 13, color: C.muted, fontFamily: SFText, lineHeight: 1.6, maxWidth: 720 },
  introCloudFigure: {
    margin: '10px 0 0',
    padding: 0,
    width: '100%',
  ...
  introCloudCredit: {
    ...
    color: 'rgba(122,148,144,0.72)',
    borderTop: 'none',
    background: 'transparent',
  },
  introCloudCreditLink: {
    color: 'rgba(122,148,144,0.9)',
    textDecoration: 'none',
  },
